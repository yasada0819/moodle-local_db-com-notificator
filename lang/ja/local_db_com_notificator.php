...
$string['commentnotification_fullmessagehtml'] = '{$a->fullname}さん、<br><br>あなたの{$a->context}エントリに{$a->commentauthor}さんから新しいコメントが投稿されました。以下のリンクで確認してください：<br><br><a href="{$a->entryurl}">確認用リンク</a><br><br>よろしくお願いします。<br>Moodleチーム';
...
$string['messageprovider:commentnotification'] = 'エントリへのコメントの通知';